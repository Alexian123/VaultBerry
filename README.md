...
| RecoveryLogin             | NO             | POST   | /recovery/login            | -           | ``` { "email": <str>, "recovery_password": <str>, "otp": <str> } ```                                                                                                                                                                                                                            | 200          | 500, 401, 404           | ``` { "salt": <base64_str>, "vault_key": <base64_str>, "recovery_key": <base64_str> } ```                                                                                  |
