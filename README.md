...
| :--------------- | :----: | :------------------------ | :------------- | :----------- | :----------: | :-----------: | :--------------------- |
| Register         | POST   | /register                 | -              | ```{```<br>&nbsp;&nbsp;```"account": {```<br>&nbsp;&nbsp;&nbsp;&nbsp;```"email": "test@email.com"```<br>&nbsp;&nbsp;```},```<br>&nbsp;&nbsp;```"keychain": {```<br>&nbsp;&nbsp;&nbsp;&nbsp;```"salt": "abcdefghabcdefghabcdefgh",```<br>&nbsp;&nbsp;&nbsp;&nbsp;```"vault_key": "test key",```<br>&nbsp;&nbsp;&nbsp;&nbsp;```"recovery_key": "test recovery key"```<br>&nbsp;&nbsp;```},```<br>&nbsp;&nbsp;```"password": {```<br>&nbsp;&nbsp;&nbsp;&nbsp;```"regular": "test",```<br>&nbsp;&nbsp;&nbsp;&nbsp;```"recovery": "test"```<br>&nbsp;&nbsp;```}```<br>```}``` | 201 | 400 | ```{"message": "User registered successfully"}``` |
...
| ChangePassword   | PATCH  | /account/password         | -              | ```{```<br>&nbsp;&nbsp;```"regular": "test",```<br>&nbsp;&nbsp;```"recovery": "abc```<br>```}``` | 201 | 400 | ```{"message": "Password changed successfully"}``` |
