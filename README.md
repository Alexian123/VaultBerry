...
| AddVaultEntry             | YES            | POST   | /vault/add/\<int:id\>             | -           | ``` { "last_modified": <big_int>, "title": <str>, "url": <str?>, "encrypted_username": <base64_str?>, "encrypted_password": <base64_str?>, "notes": <str?> } ```                                                                                                                                | 201          | 500, 401, 409           | ```{"message": "Entry added successfully"```                                                                                                                               |
